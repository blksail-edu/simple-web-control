...
with gr.Blocks() as demo:
    ...
    slider_m1.release(update_m1, inputs=[slider_m1, state], outputs=[], api_name="m1_slider")
    slider_m2.release(update_m2, inputs=[slider_m2, state], outputs=[], api_name="m2_slider")
    slider_m3.release(update_m3, inputs=[slider_m3, state], outputs=[], api_name="m3_slider")
    slider_m4.release(update_m4, inputs=[slider_m4, state], outputs=[], api_name="m4_slider")
    slider_m5.release(update_m5, inputs=[slider_m5, state], outputs=[], api_name="m5_slider")
    slider_m6.release(update_m6, inputs=[slider_m6, state], outputs=[], api_name="m6_slider")
